...
//         }`}
//       >
//         <ul className="flex text-center justify-center bg-gray-800 rounded-lg">
//           {[
//             { path: "/", label: "Home" },
...
//             <li
//               key={item.path}
//               className={`m-2 px-4 py-2 text-sm font-medium rounded-md ${
...
const Header = () => {
  ...
  return (
    <header className="bg-blue-600 text-white p-4 relative">
      ...
      >
        <ul className={`${isMobile ? "flex flex-col w-full text-center" : "flex justify-center bg-gray-800 rounded-lg"}`}>
          {[
            { path: "/", label: "Home" },
            { path: "/skills", label: "Skills" },
            { path: "/education", label: "Education" },
